...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'Profiles: use profile="openclaw" for the isolated openclaw-managed browser (default). Use profile="chrome" for Chrome extension relay takeover (your existing Chrome tabs).',
      'If the user explicitly asks for the Chrome extension / Browser Relay / toolbar button / “attach tab”, use profile="chrome".',
      'When a node-hosted browser proxy is available, the tool may auto-route to it. Pin a node with node=<id|name> or target="node".',
      'Chrome extension relay needs an attached tab: only ask the user to click the OpenClaw Browser Relay toolbar icon (badge ON) if a tab is not connected and profile="chrome" is in use.',
